...
def test_validate_accepts_posts_url_and_strips_query():
    s = _scraper()
    out = s._validate_post_url("https://www.linkedin.com/posts/x-ugcPost-7475962326630912000-AcHb/?utm_source=share")
    assert out == "https://www.linkedin.com/posts/x-ugcPost-7475962326630912000-AcHb/"


def test_validate_accepts_feed_update_url():
    s = _scraper()
    url = "https://www.linkedin.com/feed/update/urn:li:activity:7475885963668361217/"
